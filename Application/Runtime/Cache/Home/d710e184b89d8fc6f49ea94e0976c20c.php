	...
	<body>
		<div class="container">
			...
			<ol class="breadcrumb">
				 ...
				 <li><a href="/"><span class="glyphicon glyphicon-<?php  $classesmodel = D("classes"); $classwhere = array( 'name'=>$blog['class'], ); $class2 = $classesmodel->where($classwhere)->select(); $class = $class2[0]; echo $class['icon']; ?>" aria-hidden="true"></span>&nbsp;<?php if($blog['class']){echo $blog['class'];}else{echo '未分类';} ?></a></li>
			...
			<div class="col-md-12">
				<div class="panel panel-info">
				  ...
				  <div class="panel-body">
					  <div align=middle><h3><b><?php if($blog['top'] == 'true'){ ?> <span class="label label-danger"><span class="glyphicon glyphicon-arrow-up" aria-hidden="true"></span>&nbsp;置顶</span>&nbsp;<?php } echo $blog['title'];?></b></h1></div>
					  <div align=middle>
					    <p>
				...
				<div class="panel panel-info">
				  <div class="panel-heading"><a name="msg"><span class="glyphicon glyphicon-comment" aria-hidden="true"></span>&nbsp;评论</a></div>
						...
						<div class="panel panel-default">
						  <div class="panel-body">
								<form action="<?php echo U('/Home/Index/msg');?>?pid=<?php echo $blog['pid']?>" method="post">
									...
									<div class="panel panel-default" style="float:left;"><div class="panel-body">
									    ...
									    <a href="<?php echo U('/Home/Index/read');?>?pid=<?php echo $blog['pid']?>">&nbsp;<img width="100" height="30" alt="验证码" src="<?php echo U('Home/Index/verify',array());?>"></a>
									</div></div><br>
						  ...
						  <ul class="list-group">
							<?php
 foreach( $msgs as $msg){ date_default_timezone_set("Asia/Hong_Kong"); $t = date("Y年m月d日 H:i:s",$msg['time']); ?>
			...
			<form action="<?php echo U('/User/Login/index?act=chk');?>" method="post">
			  ...
			  <div class="form-group">
				...
				<div class="input-group">
				  ...
				  <div class="input-group-addon"><img width="200" height="50" alt="验证码" src="<?php echo U('User/Login/verify',array());?>"></div>
				</div>
			  </div>
			  ...
			  <div class="modal-body">
				<form action="<?php echo U('/User/Register/index?act=chk');?>" method="post">
				  ...
				  <div class="form-group">
					...
					<div class="input-group">
					  <input type="text" name='code'  class="form-control" height="50" placeholder="此处输入验证码">
					  <div class="input-group-addon"><img width="200" height="50" alt="验证码" src="<?php echo U('/User/Register/verify',array());?>"></div>
					</div>
				  </div>
			  </div>
			  <div class="modal-footer">
