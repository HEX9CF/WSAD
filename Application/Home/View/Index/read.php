...
<head>
    ...
    <meta name="keywords" content="<?php $con = strip_tags(html_entity_decode($blog['title']));
    include("Public/keyword/index.php");
    $keywords = get_keywords_str($con);
    echo $keywords; ?>"/>
    <meta name="description"
          content="<?php echo mb_substr(strip_tags(html_entity_decode($blog['content'])), 0, 200); ?>"/>
...
<div class="container">
    <?php if ($set['logo']) { ?>
        ...
        <div class="page-header">
            <div align=left><h1><img class='media-object' alt='<?php echo $set['title']; ?>'
                                     src='<?php echo $set['logo']; ?>' data-holder-rendered='true'></h1></div>
        </div>
    <?php } else { ?>
        <?php include(THEME_PATH . "nav.php"); ?>
        <div class="jumbotron">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="/"><span class="glyphicon glyphicon-<?php
                ...
                $class = $class2[0];
                echo $class['icon'];
                ?>" aria-hidden="true"></span>&nbsp;<?php if ($blog['class']) {
                    echo $blog['class'];
                } else {
                    echo '未分类';
                } ?></a></li>
        <li class="active"><span class="glyphicon glyphicon-file"
                                 aria-hidden="true"></span>&nbsp;<?php echo strip_tags($blog['title']); ?></li>
    </ol>
    <div class="col-md-12">
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                <div align=middle><h3><b><?php if ($blog['top'] == 'true') { ?> <span class="label label-danger"><span
                                        class="glyphicon glyphicon-arrow-up"
                                        aria-hidden="true"></span>&nbsp;置顶</span>&nbsp;<?php } ?><?php echo $blog['title']; ?>
                        </b></h1></div>
                <div align=middle>
                    <p>
                    ...
                    <p>
                        <span class="label label-info"><span class="glyphicon glyphicon-eye-open"
                                                             aria-hidden="true"></span>&nbsp;阅读：<?php echo $blog['read']; ?></span>&nbsp;&nbsp;
                        <span class="label label-info"><span class="glyphicon glyphicon-thumbs-up"
                                                             aria-hidden="true"></span>&nbsp;点赞：<?php echo $blog['zan']; ?></span>&nbsp;&nbsp;
                        <span class="label label-info"><span class="glyphicon glyphicon-comment"
                ...
                <a href="/">
                    <button type="button" class="btn btn-info btn-lg">
						  <span class="glyphicon glyphicon-eye-open"
                                aria-hidden="true">&nbsp;<?php echo $blog['read']; ?>
                    </button>
                </a>
                ...
                <a href="<?php echo U('/Home/Index/zan'); ?>?pid=<?php echo $blog['pid']; ?>">
                    <button type="button" class="btn btn-danger btn-lg">
							 <span class="glyphicon glyphicon-thumbs-up"
                                   aria-hidden="true">&nbsp;<?php echo $blog['zan']; ?>
                    </button>
                </a>
                ...
                <a href="#msg">
                    <button type="button" class="btn btn-success btn-lg">
							 <span class="glyphicon glyphicon-comment"
                                   aria-hidden="true">&nbsp;<?php echo $blog['msg']; ?>
                    </button>
                </a>
            </div>
        </div>
        ...
        <div class="alert alert-info" role="alert">
            ...
            本文作者：<?php echo $blog['author']; ?> ，转载需经过本文作者同意 。
        </div>
        </br>
        <div class="panel panel-info">
            <div class="panel-heading"><a name="msg"><span class="glyphicon glyphicon-comment"
                                                           aria-hidden="true"></span>&nbsp;评论</a></div>
            <div class="panel-body">
                            ...
                            <?php if (session('username') == false) { ?>
                                <div style="float:left;">
                                    <button type="button" class="btn btn-sm" data-toggle="modal" data-target="#login">
                                        <span class="glyphicon glyphicon-remove" aria-hidden="true"></span>&nbsp;游客，请登录。<span
                                                class="glyphicon glyphicon-log-in" aria-hidden="true"></span>
                                    </button>
                                </div>
                                <br>
                            <?php } else { ?>
                                <div style="float:left;"><span class="glyphicon glyphicon-user"
                                                               aria-hidden="true"></span>&nbsp;
                                    <?php echo session('username') ?></div><br>
                            <?php } ?>
                            <textarea name="msg" class="form-control"
                                      style="height:150px;"><?php echo $valmsg; ?></textarea></br>
                            <div class="panel panel-default" style="float:left;">
                                <div class="panel-body">
                                    <input type="text" name='code' placeholder="此处输入验证码">
                                    <a href="<?php echo U('/Home/Index/read'); ?>?pid=<?php echo $blog['pid'] ?>">&nbsp;<img
                                                width="100" height="30" alt="验证码"
                                                src="{:U('Home/Index/verify',array())}"></a>
                                </div>
                            </div>
                            <br>
                ...
                <ul class="list-group">
                    ...
                    foreach ($msgs as $msg) {
                        ...
                        <li class="list-group-item">
                            ...
                            <span class="glyphicon glyphicon-comment"
                                  aria-hidden="true"></span>&nbsp;<?php echo $msg['msg']; ?>
                            <span style="float:right;"><a
                                        href="<?php echo U('/Home/Index/msgzan'); ?>?pid=<?php echo $blog['pid'] ?>&mid=<?php echo $msg['mid']; ?>">
									<button type="button" class="btn btn-info btn-xs">
									  <span class="glyphicon glyphicon-thumbs-up"
                                            aria-hidden="true"></span>&nbsp;<?php echo $msg['msgzan'] ?>
									</button>
									</a>
                        </li>
                    <?php } ?>
...
<script>window._bd_share_config = {
        "common": {
            "bdSnsKey": {
                "tsina": "<?php echo $blog['title'];?>",
                "tqq": "<?php echo $blog['title'];?>",
                "t163": "<?php echo $blog['title'];?>",
                "tsohu": "<?php echo $blog['title'];?>"
            },
            "bdText": "<?php echo $blog['title'];?>",
            "bdMini": "2",
            "bdMiniList": false,
            "bdPic": "<?php echo $blog['img'];?>",
            "bdStyle": "0",
            "bdSize": "16"
