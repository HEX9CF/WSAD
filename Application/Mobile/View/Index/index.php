                        ...
                        <?php foreach ($slides as $slide): ?>
                            ...
                            <div class="item<?php if ($active == true) {
                                ...
                                <a href="<?php echo "http://" . $_SERVER['HTTP_HOST'] . U('/Mobile/Index/read'); ?>?pid=<?php echo $slide['pid']; ?>">
                                    <img alt="<?php echo $slide['title']; ?>" style='width: 100%; height: 250px;'
            ...
            <div class="thumbnail">
                <div class="caption" align=middle>
                    ...
                    <p>
                        ...
                        if (!session('uid')) {
                            ?>
                            <a href="<?php echo U("/Mobile/Register/index"); ?>">
                            ...
                            ?>
                            <a href="<?php echo U("/User/Submit/index"); ?>">
                                <button type="button" class="btn btn-default">投稿</button>
                            </a>
                            <a href="<?php echo U("/Mobile/Login/logout"); ?>">
                    ...
                    if (!$blog['img'] == false) {
						...
						<?php if ($blog['class']) {
                            ...
                            echo '未分类';
                                        ...
                                        <b><?php echo $blog['title']; ?></b><br></h5><br>
                                    <img class='media-object' alt='<?php echo $blog['title']; ?>'
                                         src='<?php echo $blog['img']; ?>'
                                         style='width: 100%; height: 200px; display: block;' class="img-thumbnail"><br>
